---
title: "WineRy"
subtitle: "An App for the Wine Enthusiast"
...
ggplot()+
  ...
  geom_polygon(data = wine_map, 
               aes(x=long, y = lat, group = group, fill = Points)) +
  theme(
...
```{r spider, fig.height=6,fig.width=6, echo = F, eval=T, warning=F, message=F}
